    ...
    >
      ...
      >
        <div className="flex flex-col w-full lg:w-[560px] p-6 bg-white rounded-3xl shadow">
          <div className="flex flex-col gap-4 p-7 rounded-2xl bg-gradient-to-br from-[#020d1a] via-[#03294a] to-[#0c4a6e]">
            ...
            <div className="flex gap-3">
              {statCards.map((card) => (
                <article key={card.label} className={card.wrapperClass}>
                  <div className="flex items-center gap-2">
                    <img src={card.icon} alt={card.label} className="w-4 h-4" />
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between">
                ...
                <span className="text-white text-xs font-semibold">93.3%</span>
              </div>
              <div
            ...
            <div className="flex flex-col gap-4 mt-4">
              ...
              >
                ...
                <img
                  ...
                  className="absolute w-full h-full top-0 left-0"
                />
                <div className="absolute top-[85%] left-0 text-[10px] text-slate-600">
                  1일
                </div>
                <div className="absolute top-[85%] left-[46%] text-[10px] text-slate-600">
                  15일
                </div>
                <div className="absolute top-[85%] left-[94%] text-[10px] text-slate-600">
                  30일
                </div>
              </div>
        ...
        <div className="flex flex-col w-full lg:w-[700px]  gap-6">
          <div className="inline-flex items-start justify-start px-[18px] py-[7px] bg-green-100 rounded-3xl w-fit animate-in fade-in scale-in duration-500 delay-100">
          ...
          <h3 className="font-extrabold text-sky-900 text-left text-base text-[38px] leading-tight animate-in fade-in slide-in-from-top-4 duration-500 delay-150">
            입출고 흐름과 재고 소진율을
